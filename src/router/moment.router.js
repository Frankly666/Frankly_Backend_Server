...
const { insertMoment, searchAllMoment, serchMomentById, deleteMoment } = require("../controller/momentController");
...
// 删除动态信息操作
momentRouter.delete("/delete/:momentId", verifyAuth, verifyPermission, deleteMoment)
